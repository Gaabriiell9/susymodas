...
export default function Hero() {
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden bg-gradient-to-br from-cream via-blush/60 to-gold-pale">
      ...
      {/* Cercles décoratifs */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-gold/10 -translate-x-16 pointer-events-none" />
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-gold/15 pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 sm:py-16">
        ...
        <div className="animate-fade-left">
          ...
          <h1
            className="font-serif font-light leading-[1.08] text-brown mb-5"
            style={{ fontSize: 'clamp(3rem,5.5vw,5.5rem)' }}
          >
            L&apos;Élégance<br />
            au Service de<br />
            <em className="text-gold not-italic" style={{ fontStyle: 'italic' }}>la Foi</em>
          </h1>
        ...
        <div className="hidden lg:flex justify-center items-center">
          <div className="relative">
            <div className="w-[400px] h-[520px] rounded-[200px_200px_180px_180px] bg-gradient-to-b from-white to-blush shadow-2xl flex items-center justify-center animate-float">
              <span className="text-[9rem] select-none" aria-hidden>
                👗
              </span>
            </div>
